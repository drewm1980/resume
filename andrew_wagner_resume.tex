...
\address{
	...
	\begin{ncolumn}{2}
		Wellingstraat 99 Bus 1 & email: andrew.wagner@esat.kuleuven.be\\
		9000 Ghent & GSM: 0474 25 82 28\\
...
\item
	...
	\employer{KU Leuven and U. of Freiburg, HIGHWIND Project \\ Supervisor: Prof. Moritz Diehl}
	\location{Leuven, Belgium and Freiburg, Germany}
	\dates{Jan. 2012 -- Present. Available on 1 month notice}
	\begin{position}
	\vspace{-2mm}
	\begin{itemize}
