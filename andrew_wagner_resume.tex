...
\address{
	...
	\begin{ncolumn}{2}
		...
		9000 Ghent & GSM when in BE: 0474 25 82 28\\
			  Belgium & GSM when in DE: +49 1758410275
	\end{ncolumn}
}
...
{\bf \footnotesize Thesis: Robust Scalable Face Recognition via Sparse
...
\item
	...
	\employer{KU Leuven and U. of Freiburg \\ Supervisor: Prof. Moritz Diehl}
	\location{Leuven, Belgium and Freiburg, Germany}
	\dates{Jan. 2012 -- Aug. 2014 (flexible)}
	\begin{position}
	\vspace{-2mm}
	\begin{itemize}
...
\item
	...
	\employer{University of Illinois, Perception Lab\\ Advisor: Prof. Yi Ma}
