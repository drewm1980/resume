...
{\bf \footnotesize Thesis: Robust and Scalable Face Recognition via 
Parallelized $\ell_1$ Minimization}
\end{position}
...
\item 
\spaceline
{\bf Computer Vision:} Face recognition, Depth cameras, 3D reconstruction, Visual tracking, Computational photography,
HDR imaging, Stereo photography, Parallelization of $\ell_1$ solvers for large problems, GPU acceleration of vision algorithms.
